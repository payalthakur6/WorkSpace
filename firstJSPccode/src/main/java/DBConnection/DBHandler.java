...
public class DBHandler{
	...
	try {
			Connection connection= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE", "SYSTEM", "payal1234");
...
//			stmt.execute("create table loginQuiz(mailId varchar(30),password varchar(20),name varchar(20))");
	//		stmt.execute("insert into loginQuiz values('robinrk626@gmail.com','payal1234','Robin Kumar')");
